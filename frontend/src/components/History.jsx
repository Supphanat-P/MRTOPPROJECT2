      ...
      {loading ? (
        ...
        <div className="history-table-wrapper">
            ...
            <tbody>
              {paginatedPackets.map((packet, idx) => (
                <tr
                  ...
                  onClick={() => setSelectedPacket(selectedPacket === packet ? null : packet)}
                >
          ...
          <div className="pagination-container">
            ...
            <span className="pagination-text">Page {currentPage + 1} of {totalPages || 1}</span>
            <button
              className="btn-pagination"
          ...
          <table className="packet-detail-table">
            <tbody>
              ...
              {selectedPacket.flags && (
                <tr>
                  <td>TCP Flags:</td>
                  <td>{typeof selectedPacket.flags === 'object' ? JSON.stringify(selectedPacket.flags) : selectedPacket.flags}</td>
                </tr>
              )}
                ...
                <tr>
                  ...
                  <td>
                    <pre className="payload-pre">
                      {typeof selectedPacket.payload === 'string' ? selectedPacket.payload.replace(/[^\x20-\x7E\n\r\t]/g, ".").slice(0, 1000) : JSON.stringify(selectedPacket.payload)}
                    </pre>
                    <div className="payload-meta">
                      <span>printable ASCII · non-printable &rarr; <code>.</code></span>
                      {typeof selectedPacket.payload === 'string' && (
                        <span><strong>{selectedPacket.payload.length}</strong> chars shown</span>
                      )}
                    </div>
                  </td>
                </tr>
